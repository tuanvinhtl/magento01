...
class Interceptor extends \Amazon\Payment\Model\ResourceModel\PendingCapture\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdGenerator');
        return $pluginInfo ? $this->___callPlugins('getIdGenerator', func_get_args(), $pluginInfo) : parent::getIdGenerator();
    }
