...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Importer\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsWithImportingStatus');
        return $pluginInfo ? $this->___callPlugins('getItemsWithImportingStatus', func_get_args(), $pluginInfo) : parent::getItemsWithImportingStatus($websiteIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQueueByTypeAndMode');
        return $pluginInfo ? $this->___callPlugins('getQueueByTypeAndMode', func_get_args(), $pluginInfo) : parent::getQueueByTypeAndMode($importType, $importMode, $limit, $websiteIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fetchImporterTasksWithErrorStatusInTimeWindow');
        return $pluginInfo ? $this->___callPlugins('fetchImporterTasksWithErrorStatusInTimeWindow', func_get_args(), $pluginInfo) : parent::fetchImporterTasksWithErrorStatusInTimeWindow($timeWindow);
    }
