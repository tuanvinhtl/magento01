...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Automation\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAutomationStatusType');
        return $pluginInfo ? $this->___callPlugins('getAutomationStatusType', func_get_args(), $pluginInfo) : parent::getAutomationStatusType();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionByType');
        return $pluginInfo ? $this->___callPlugins('getCollectionByType', func_get_args(), $pluginInfo) : parent::getCollectionByType($type, $limit);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionByPendingStatus');
        return $pluginInfo ? $this->___callPlugins('getCollectionByPendingStatus', func_get_args(), $pluginInfo) : parent::getCollectionByPendingStatus($expireTime);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastPendingStatusCheckTime');
        return $pluginInfo ? $this->___callPlugins('getLastPendingStatusCheckTime', func_get_args(), $pluginInfo) : parent::getLastPendingStatusCheckTime();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAbandonedCartAutomationByQuoteId');
        return $pluginInfo ? $this->___callPlugins('getAbandonedCartAutomationByQuoteId', func_get_args(), $pluginInfo) : parent::getAbandonedCartAutomationByQuoteId($quoteId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubscriberAutomationByEmail');
        return $pluginInfo ? $this->___callPlugins('getSubscriberAutomationByEmail', func_get_args(), $pluginInfo) : parent::getSubscriberAutomationByEmail($email);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAbandonedCartAutomationsForContactByInterval');
        return $pluginInfo ? $this->___callPlugins('getAbandonedCartAutomationsForContactByInterval', func_get_args(), $pluginInfo) : parent::getAbandonedCartAutomationsForContactByInterval($email, $updated);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fetchAutomationEnrolmentsWithErrorStatusInTimeWindow');
        return $pluginInfo ? $this->___callPlugins('fetchAutomationEnrolmentsWithErrorStatusInTimeWindow', func_get_args(), $pluginInfo) : parent::fetchAutomationEnrolmentsWithErrorStatusInTimeWindow($timeWindow);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fetchAutomationEnrolmentsWithPendingStatusInTimeWindow');
        return $pluginInfo ? $this->___callPlugins('fetchAutomationEnrolmentsWithPendingStatusInTimeWindow', func_get_args(), $pluginInfo) : parent::fetchAutomationEnrolmentsWithPendingStatusInTimeWindow($timeWindow);
    }
